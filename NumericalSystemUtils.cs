...
namespace GuidUsage
{
  ...
  hex.Select(
    c => Convert.ToString(Convert.ToInt32(c.ToString(), 16), 2).PadLeft(4, '0')
        ...
        //Task3
        public static string ReverseBits(string hex)
        {
            return BinaryToHex(ReverseString(HexToBinary(hex)));
        }

        //Task4
        public static string SumHexNumbers(string hex1, string hex2)
        {
        ...
        //Task5
        public static string SubtructHexNumbers(string hex1, string hex2)
        {
            var modifiedHex = MakeHexValuesTheSameLength(hex1, hex2);
            hex1 = modifiedHex.Item1;
            hex2 = modifiedHex.Item2;
        ...
        //Task6
        public static string HexSignedToDecimal(string hex)
        {
        ...
        //Task7
        public static string HexChangeSign(string hex)
        {
            string binarySigned = HexToBinary(hex);
        ...
        //Task8
        public static string HexAdditionalToDecimal(string hex)
        {
        ...
        //Task 9
        public static string HexAdditionalChangeSign(string hex)
        {
        ...
        private static Tuple<string, string> MakeHexValuesTheSameLength(string hex1, string hex2)
        {
        ...
        internal static string FromAdditionalToStraight(string binary)
        {
            if (binary.StartsWith('1'))
            {
                bool hasSub = false;
